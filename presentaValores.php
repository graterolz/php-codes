<?php
	...
	// función para imprimir todos los valores en una matriz anidada
	function presentaValores($arr) {
		...
		// envía retorno al invocador del total contado y los valores encontrados
		// como una matriz
